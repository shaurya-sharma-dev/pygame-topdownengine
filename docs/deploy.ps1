...
if (-not $?) {
    Write-Host "⚠️ Remote 'gh-pages' branch not found. Creating a fresh '$TARGET_DIR' folder..." -ForegroundColor Yellow
...
Write-Host "mporting and forcing update to gh-pages..." -ForegroundColor Green
