...
class GameObject(pg.sprite.Sprite):
    ...
    Attributes:
        ...
        on_game_object (GameObject|None): Current `GameObject` this `GameObject` is standing on.
        standing_on_rect (pg.Rect|pg.FRect|None): Current hitbox this `GameObject` is standing on.
        prev_standing_on_rect (pg.Rect|pg.FRect|None): Hitbox this `GameObject` was standing on in the previous frame.
        ...
        prev_hitboxes (list[pg.Rect|pg.FRect]): List of world-space hitboxes in the previous frame.
